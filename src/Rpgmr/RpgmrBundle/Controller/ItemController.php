...
use Rpgmr\RpgmrBundle\Entity\Item;
use Rpgmr\RpgmrBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RpgmrBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("RpgmrBundle:Item:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RpgmrBundle:Item')->find($id);
     ...
     * @Method("PUT")
     * @Template("RpgmrBundle:Item:edit.html.twig")
     */
